        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicShareToken = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizSessions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuizSessions_AspNetUsers_HostUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FactCheckFlagged = table.Column<bool>(type: "boolean", nullable: false),
                    FactCheckNote = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Questions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Questions_QuizTopics_TopicId",
                        column: x => x.TopicId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnswerText = table.Column<string>(type: "text", nullable: false, defaultValue: ""),
                    IsCorrect = table.Column<bool>(type: "boolean", nullable: true),
                    PointsAwarded = table.Column<decimal>(type: "numeric(3,2)", precision: 3, scale: 2, nullable: false),
                    GradingNote = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Answers_QuizSessionId_QuestionId",
                table: "Answers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizSessions_HostUserId",
                table: "QuizSessions",
                column: "HostUserId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizSessions_PublicShareToken",
                table: "QuizSessions",
